	...
	<div class="card">
		<div class="card-body">
			<div class="card card-sm">
				<div class="card-header"><p class="lead float-left">Appointment Information</p> <span class="float-right">
					<a href="/dashboard/appointmentlist" class="btn mr-3 btn-default">Appointment List</a><a href="/dashboard/patient/{{$appointment->patient->id}}/appointment" class="btn btn-default">Go Back</a></span></div>
				<div class="card-body">
					<div class="row">
						<div class="col-8">
