   ...
   loadBarChart();
	...
	<div class="card card-success">
              <div class="card-header">
                <h3 class="card-title text-center">Monthly Net Sales of {{date('Y')}} (Billing)</h3>
  ...
  <div class="card collapsed-card">
    ...
    <div class="card-body">
      ...
      <div class="col-md-6 mx-auto">
        <form action="/dashboard/billing/generateReport" method="POST">
          @csrf
					...
					<tbody>
						...
						@foreach($reports as $report)
							<tr>
								...
								<td>
									<a href="billing/{{$report->rcode}}/receipt" class="btn btn-default btn-sm"><i class="fa fa-print"></i> View Receipt</a>
								</td>
							</tr>
						@endforeach
					</tbody>
