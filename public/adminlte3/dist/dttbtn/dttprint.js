...
DataTable.ext.buttons.print = {
	...
	action: function ( e, dt, button, config ) {
		...
		if(config.repeatingHead.logo) {
			...
			html += '<tr><th colspan="'+data.header.length+'" ><h3 class="float-left">Dr S & J Veterinary Clinic and Grooming Centre</h3> <img style="width:5%" class="float-right" src="'+config.repeatingHead.logo+'"/></th></tr>';
		}
