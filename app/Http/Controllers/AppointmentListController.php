...
{	
    ...
    public function reschedule(Request $request){
        ...
        \App\Systemlog::create(['user'=>Auth::user()->name ,'role' => ucfirst(Auth::user()->role),'activity' =>' Appointment with pet '.$appointment->patient->name.' owned by Mr/Mrs. '.$appointment->patient->client->name.' was Rescheduled to "'.$request->reschedule_date.'" from previous date '.$request->prev_date]);
